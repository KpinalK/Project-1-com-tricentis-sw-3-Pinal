...
//        //1.4 Verify the Product will be arranged in Descending order.
    ...
    public void verifyProductAddedToShoppingCartSuccessFully() {
        ...
        sendTextOnElement(By.id("BillingNewAddress_FirstName"), "Pinal");

        //2.24 Enter the Last name
        sendTextOnElement(By.id("BillingNewAddress_LastName"), "Kamani");

        //2.25 Enter the email
        sendTextOnElement(By.id("BillingNewAddress_Email"), "Pinal123@gmail.com");
