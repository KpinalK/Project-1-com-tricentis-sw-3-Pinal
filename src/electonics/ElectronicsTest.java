...
public class ElectronicsTest extends Utility {
    ...
    public void verifyThatTheProductAddedSuccessfullyAndPlaceOrderSuccessfully() throws InterruptedException {
        ...
        sendTextOnElement(By.xpath("//input[@id='FirstName']"), "manvi");

        //2.23 Enter the Last name
        sendTextOnElement(By.xpath("//input[@id='LastName']"), "shah");

        //2.24 Enter the Email
        sendTextOnElement(By.xpath("//input[@id='Email']"), "manvi@gmail.com");

        //2.25 Enter the Password
        sendTextOnElement(By.xpath("//input[@id='Password']"), "manvi1234");

        //2.26 Enter the Confirm password
        sendTextOnElement(By.xpath("//input[@id='ConfirmPassword']"), "manvi1234");
        ...
        //2.34 Enter the city
        sendTextOnElement(By.id("BillingNewAddress_City"), "Derby");

        //2.35 Enter the Address1
        sendTextOnElement(By.id("BillingNewAddress_Address1"), "56A Lodge road");

        //2.36 Enter the Zip/Postal code
        sendTextOnElement(By.id("BillingNewAddress_ZipPostalCode"), "D63 356");

        //2.37 Enter the Phone number
        sendTextOnElement(By.id("BillingNewAddress_PhoneNumber"), "2568974513");
        ...
        sendTextOnElement(By.xpath("//input[@id='CardholderName']"), "Pinal Kamani");
